...
>Icarus_Radio大神曾在chiphell回答内核版本的[```帖子```](https://www.chiphell.com/thread-2608128-1-1.html)里提到，“估计要降。虽然教程里说 DKMS 和内核版本不相关，但是我试过好几个版本不用他指定的内核都会报错。”，但实际上经我在6.6内核的truenas 24.4.2.2版本测试，安装编译对内核已经没有要求 \
